...
@click.option('--job-group',
              ...
              type=str,
              required=False,
              help=('Attach the job to an existing managed job (a job group) '
                    'as a dynamic member, by job id or by the name of a '
                    'unique running job. The job is listed under that job '
                    'and cancelled with it. Defaults to the surrounding job '
